...
@Ignore
public class HttpRequestRecipientListTestCase extends AbstractHttpOsgiFunctionalTestCase
{
    ...
    {
        final MuleEvent testEvent = AbstractMuleContextTestCase.getTestEvent(AbstractMuleContextTestCase.TEST_MESSAGE);
