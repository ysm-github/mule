 ...
 * LICENSE.txt file.
 */
package org.mule.module.extension.spring.internal.xml;
...
public class SpringBundleResourceContributor implements GenerableResourceContributor
{
    ...
    {
        //TODO(pablo.kraan): OSGi - need to use a handler that is inside the bundle
        String content = String.format("%s=%s", capability.getSchemaLocation(), "org.mule.extension.validation.ValidationNamespaceHandler");
